  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          const Center(child: Text('Lets get to work!', style: TextStyle(color: Colors.black, fontSize: 32, fontWeight: FontWeight.bold),)),
          ElevatedButton(
            onPressed: () {
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const ViewCourses()));
            },
            style: ButtonStyle(
              shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                  RoundedRectangleBorder(
